...
function wonGameTemplate() {
    return `
    <div id="endWinScreenBox"> 
            <img src="./img/Startscreen/youWin.png" alt="You Win">
      <div class="restart_btn_container">
            <button class="Winplay_again_btn" onclick="init()">HOME</button>
            <button class="play_again_btn" onclick="restartGame()">PLAY AGAIN</button>
      </div>
      </div>
`
}
...
function lostGameTemplate() {
    return `
    <div id="endOverScreenBox"> 
          <img src="./img/Startscreen/GameOver.png" alt="Game Over">
      <div class="restart_btn_container">
            <button class="play_again_btn" onclick="init()">HOME</button>
            <button class="play_again_btn" onclick="restartGame()">PLAY AGAIN</button>
      </div>
      </div>
`
...
function generateOptionsPage(content, activePage) {
    return `
        <div id="endScreenBox"> 
            <div class="option_container">
                <div class="option_content">
                    <div class="navbar">
                        <button class="option_btn ${activePage === 'datenschutz' ? 'active' : ''}" onclick="options('datenschutz')">Datenschutz</button>
                        <button class="option_btn ${activePage === 'credits' ? 'active' : ''}" onclick="options('credits')">Credits</button>
                        <button class="option_btn ${activePage === 'impressum' ? 'active' : ''}" onclick="options('impressum')">Impressum</button>
                    </div>  
...
function datenschutz() {
    return generateOptionsPage(`<h4>Datenschutz&shy;erkl&auml;rung</h4>
<h4>1. Datenschutz auf einen Blick</h4>
<h5>Allgemeine Hinweise</h5> <p>Die folgenden Hinweise geben einen einfachen &Uuml;berblick dar&uuml;ber,
...
dieser Website ist:</p> <p>Caryen Song<br />
Johannes-Wirtz-Str. 19<br />
47877 Willich</p>
<p>Telefon: 01789731129<br />
E-Mail: caryensong@googlemail.com</p>
